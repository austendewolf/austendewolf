 ...
 * them: the day strip and the list are rendered by the controller, which is the
...
export function Daybook({
  ...
  return (
    <div className="daybook" ref={root}>
      <div className="shell">
        {/* The days run across the top as one strip that slides under a fixed window. */}
        <nav className="rail" aria-label="Days">
          <div className="days-vp">
